...
# [url]               The temporary secured S3 bucket download link generated by Shopify.
...
# [query]             The fully compiled outbound GraphQL structural document string passed to Shopify.
...
class CreateXEngineShopifyBulkOperations < XEngine::Core::Database::Migration
  ...
  def up 
    create_table table_name, **table_options do |t|
      ...
      t.index [:shop_id, :object_type], name: 'idx_shopify_bulk_ops_on_shop_and_object_type'
    end
  end
